...
// "player2 wins"
	...
	@Test
	public void testTennisGame_bothPlayers_15_15() throws TennisGameException {
		//Arrange
		TennisGame game = new TennisGame();
	...
	public void testTennisGame_player1_30_love() throws TennisGameException {
		...
		String score = game.getScore() ;
		// Assert
		assertEquals("Score should be: 30 - love", "30 - love", score);	
		}
	...
	public void testTennisGame_player1HasAdvantage() throws TennisGameException {
		...
		String score = game.getScore() ;
		// Assert
		assertEquals("Player2 has advantage", "player1 has advantage", score);		
	}
	...
	public void testTennisGame_player2HasAdvantage() throws TennisGameException {
		...
		String score = game.getScore() ;
		// Assert
		assertEquals("Player1 has advantage", "player2 has advantage", score);		
	}
	...
	public void testTennisGame_player1Wins() throws TennisGameException {
		...
		String score = game.getScore() ;
		// Assert
		assertEquals("Player1 loses", "player1 wins", score);
	}
	...
	public void testTennisGame_player2Wins() throws TennisGameException {
		...
		String score = game.getScore() ;
		// Assert
		assertEquals("Player2 loses", "player2 wins", score);		
	}
